...
create table
  ...
  public.ledgers (
    ...
    carts_id integer null,
    potions_id integer null,
    barrels_id integer null,
    potion_transactions integer null default 0,
    gold_transactions integer null default 0,
    ml_transactions integer null default 0,
    constraint ledgers_pkey primary key (id),
    constraint ledgers_carts_id_fkey foreign key (carts_id) references carts (id) on update cascade on delete cascade,
    constraint ledgers_potions_id_fkey foreign key (potions_id) references potions (id) on update cascade on delete cascade
  ) tablespace pg_default;